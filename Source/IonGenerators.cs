...
#if DEBUG
            Debug.Log("IonModuleGenerator.InitilizeValues() " + this.part.name + " " + generatorName);
#endif
...
#if DEBUG
            Debug.Log("IonModuleGenerator.FirstUpdateInitilize() " + this.part.name + " " + generatorName);
#endif
        }
