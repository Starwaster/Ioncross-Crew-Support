...
namespace IoncrossKerbal
{
	...
	public class IonModuleDisplay : PartModule
	{
		...
		public static IonModuleDisplay FindDisplayModule(AvailablePart part, IonResourceData resource)
		{
#if DEBUG
            Debug.Log("IonModuleDisplay.FindDisplayModule() " + part.name + ": " + resource);
#endif
        ...
        \************************************************************************/
		public static IonModuleDisplay FindAndCreateDisplayModule(AvailablePart part, IonResourceData resource)
		{
#if DEBUG
			Debug.Log("IonModuleDisplay.FindDisplayModule() " + part.name + ": " + resource);
#endif
			...
			if (null == displayModule)
			{
				...
				try
				{
					displayModule = (IonModuleDisplay)part.partPrefab.AddModule("IonModuleDisplay", true);
				}
